...
export class EventsController {
  ...
  @Post()
  create(@Body() createEventsRequest: CreateEventRequest) {
    return this.eventsService.create(createEventsRequest);
  }
  ...
  update(
    @Param('id') id: string,
    @Body() updateEventsRequest: UpdateEventRequest,
  ) {
    return this.eventsService.update(id, updateEventsRequest);
  }
